CREATE OR REPLACE DYNAMIC TABLE {{env}}_alecs_bytes.raw_pos.daily_sales_hamburg
...
FROM
    {{env}}_alecs_bytes.raw_pos.order_header oh
JOIN
    {{env}}_alecs_bytes.raw_pos.location loc
ON
